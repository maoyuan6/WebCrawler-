...
{
    public partial class HeadEdit : BaseModuleForm
    {
        public HeadEdit()
        {
            InitializeComponent();
        ...
        void LoadData()
        {
            IEMRTEMPLET_HEADERList list = WinnerHIS.Clinic.Case.DAL.Interface.DALHelper.DALManager.CreateEMRTEMPLET_HEADERList();
            list.Session = this.Session;
            list.GetAllList();
            this.gridHeadInfo.DataSource = list;
        }
    }
}
